      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl my-8">
        ...
        <div className="p-6 space-y-6 text-sm">
          ...
          {(pharmacy.licenseDocument || pharmacy.qualificationDocument || pharmacy.pharmacyRegDocument) && (
            <section><h3 className="text-xs font-semibold uppercase tracking-widest text-gray-400 mb-3">📄 Documents</h3><div className="grid gap-2">
              {pharmacy.licenseDocument && <button onClick={() => setSelectedDocument(pharmacy.licenseDocument)} className="flex items-center gap-2 p-3 bg-gray-50 hover:bg-blue-50 border border-gray-200 hover:border-blue-300 rounded-lg transition-colors text-left"><span className="text-blue-600">📜</span><div><p className="text-sm font-medium text-gray-900">Pharmacist License</p><p className="text-xs text-gray-500">Click to view</p></div></button>}
              {pharmacy.qualificationDocument && <button onClick={() => setSelectedDocument(pharmacy.qualificationDocument)} className="flex items-center gap-2 p-3 bg-gray-50 hover:bg-blue-50 border border-gray-200 hover:border-blue-300 rounded-lg transition-colors text-left"><span className="text-blue-600">🎓</span><div><p className="text-sm font-medium text-gray-900">Qualification Certificate</p><p className="text-xs text-gray-500">Click to view</p></div></button>}
              {pharmacy.pharmacyRegDocument && <button onClick={() => setSelectedDocument(pharmacy.pharmacyRegDocument)} className="flex items-center gap-2 p-3 bg-gray-50 hover:bg-blue-50 border border-gray-200 hover:border-blue-300 rounded-lg transition-colors text-left"><span className="text-blue-600">🏥</span><div><p className="text-sm font-medium text-gray-900">Pharmacy Registration</p><p className="text-xs text-gray-500">Click to view</p></div></button>}
            </div></section>
          )}
        </div>
