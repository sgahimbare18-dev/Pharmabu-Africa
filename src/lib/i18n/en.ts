...
export const en = {
  ...
  patientDashboard: {
    ...
    tabDrugSafety: "Drug Safety",
    tabProfile: "Profile",
    
    // Drug Safety
    drugSafetyTitle: "Drug Interaction Checker",
    drugSafetySubtitle: "Check if your medications are safe to take together",
    drugSafetyAddDrug: "Add a medication",
    drugSafetyPlaceholder: "Enter medication name (e.g., ibuprofen, warfarin)",
    drugSafetyCheck: "Check Interactions",
    drugSafetyClear: "Clear All",
    drugSafetyResultSafe: "✅ Safe - No interactions found",
    drugSafetyResultDanger: "⚠️ Warning - Dangerous interactions detected!",
    drugSafetyResultModerate: "⚠️ Caution - Moderate interactions found",
    drugSafetyAddToCart: "Add to Order",
